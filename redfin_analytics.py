...
# s3 buckets
target_bucket_name = 'rf-transform-zone'

# url link from - https://www.redfin.com/news/data-center/
url_by_state = 'https://redfin-public-data.s3.us-west-2.amazonaws.com/redfin_market_tracker/state_market_tracker.tsv000.gz'
...
def transform_data(task_instance):
    ...
    'is_seasonally_adjusted','region', 'state', 'state_code', 'property_type', 'property_type_id',
    'median_sale_price', 'median_list_price', 'median_ppsf', 'median_list_ppsf', 'homes_sold',
    'inventory', 'months_of_supply', 'median_dom', 'avg_sale_to_list', 'sold_above_list', 'last_updated']
...
with DAG('redfin_analytics_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_redfin_data")[0]}} s3://store-rawdata-yml',
        )
